...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("https://backend-gamma-mocha-34.vercel.app/api/v1/register", {
        method: "POST",
      ...
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-neutral/70 font-semibold">
            Create your multi-agent investment research account
          </p>
        </div>
        ...
        <div className="glass-card p-6 border border-white/5 shadow-2xl relative">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-neutral uppercase tracking-wider block">Confirm Password</label>
              <input
                type="password"
